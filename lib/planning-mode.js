...
export function getPrimaryParticipantDestinationIds(
  selectedDestinationId,
  routeDestinationIds = [],
  promotedDestinationIds = []
) {
  return normalizeDestinationIds([
    selectedDestinationId,
    ...routeDestinationIds,
    ...promotedDestinationIds,
  ]);
...
export function promotePrimaryParticipantDestinationIds(
  currentPrimaryDestinationIds,
  promotedDestinationId
) {
  return normalizeDestinationIds([
    ...normalizeDestinationIds(currentPrimaryDestinationIds),
    promotedDestinationId,
  ]);
}
